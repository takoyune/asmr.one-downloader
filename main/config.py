...
class ConfigSchema(BaseModel):
    ...
    audio_language_priority: List[str] = Field(default_factory=lambda: ["ja-jp", "en-us", "zh-cn"])
...
class ConfigManager:
    ...
    def __init__(self, data: ConfigSchema = None):
        ...
        self.audio_language_priority = getattr(data, 'audio_language_priority', ["ja-jp", "en-us", "zh-cn"])
    ...
    def save(self) -> None:
        ...
        data = {
            ...
            "audio_language_priority": self.audio_language_priority,
